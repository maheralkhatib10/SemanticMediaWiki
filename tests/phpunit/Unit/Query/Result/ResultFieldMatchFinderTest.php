...
class ResultFieldMatchFinderTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->contentFetcher = $this->getMockBuilder( '\SMW\Query\Result\ContentFetcher' )
			->disableOriginalConstructor()
			->getMock();
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			...
			new ResultFieldMatchFinder( $this->store, $this->contentFetcher, $this->printRequest )
		);
	}
	...
	public function testFindAndMatch_PROP() {
		...
		$this->contentFetcher->expects( $this->once() )
			->method( 'fetch' )
			->with(
				$this->equalTo( [ $dataItem ] ),
